...
public class CategoriaController {
    ...
    public void deleteCategoria (@Valid @PathVariable Long id){
        Optional<Categoria> categoria = categoriaRepository.findById(id); //como se fosse map

        if (categoria.isEmpty()) //checagem se é vazio...
            throw new ResponseStatusException(HttpStatus.NOT_FOUND); //caso não encontre "joga" uma nova resposta

        categoriaRepository.deleteById(id); //chamo o método postagemRepository
    }
}
